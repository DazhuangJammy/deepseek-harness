...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'client-ui-agent-preset ExpertOptimizeAction id \'expert-optimize\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'main.conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-brand-official OfficialHeroBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.hero.brand.name',
    kind: 'single',
    scope: 'root',
    summary: 'Brand name shown as the blank-session headline.',
    doc: 'Brand name shown as the blank-session headline.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'main.conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-brand-official OfficialHeroBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'main.conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-agent-preset ExpertWelcome id \'expert-welcome\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-learning LearningView id \'learning\'',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-brand-official BrandSettingsCard',
  ...
  },
  {
    ...
    occupants: [
      ...
      'experimental-client-ui-desktop-packager DesktopPackagerTab id \'desktop\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-agent-preset ExpertPanel',
