...
| `@deepseek-ai/dsh-client-ui-learning` | no | Read-only Agent architecture learning view for DeepSeek Harness sessions |
...
| `@deepseek-ai/dsh-experimental-client-ui-desktop-packager` | no | Desktop packager Settings tab and /desktop command for the Web client |
...
| `@deepseek-ai/dsh-experimental-desktop-packager` | yes | Host-side desktop packaging runner: runs the repository's own unsigned packaging script with observable progress |
