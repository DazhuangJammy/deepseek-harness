 ...
 * @module @deepseek-ai/dsh-agent-preset-registry/metadata
 */
 ...
 *
 * Absent, unparsable, and wrongly-shaped files are all the same answer — empty
 * metadata — because the caller renders a picker, not a diagnostic.
