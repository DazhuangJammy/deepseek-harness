...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ExpertRoster: 'expert roster is owned by packages/preset/agent-presets/README.md',
  ExpertDocument: 'expert editor document is owned by packages/preset/agent-presets/README.md',
  ExpertVersionComparison: 'expert version comparison is owned by packages/preset/agent-presets/README.md',
  ExpertIcon: 'expert icon vocabulary is owned by packages/preset/agent-presets/README.md',
  ExpertOptimizationOutcome: 'expert refinement settlement is owned by packages/preset/agent-presets/README.md',
  ExpertOptimizationProposal: 'expert refinement candidate is owned by packages/preset/agent-presets/README.md',
  ExpertOptimizationRun: 'expert refinement run identity is owned by packages/preset/agent-presets/README.md',
  ExpertProposalId: 'expert proposal identity is owned by packages/preset/agent-presets/README.md',
