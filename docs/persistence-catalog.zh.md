...
来源：[`packages/preset/agent-preset-registry/src/expert-session.ts:16`](../packages/preset/agent-preset-registry/src/expert-session.ts)
...
| `id` | 必需 | `string` |
| `role` | 必需 | `"developer"` |
| `source` | 必需 | [`MessageSource`](#persistence-type-sha256-e1d507a7b44c7dd40c131889c474dc8b524cfde32f6146636f969a0bef7e978f) |

消息源兼容策略：`source` — `session-source-attribution` v1; `session.developer-message.source`; `kind`; `preserve`.

仅表示归属的新增 kind：`expert-refinement`, `tmux-context`.
...
来源：[`packages/preset/agent-preset-registry/src/expert-session.ts:11`](../packages/preset/agent-preset-registry/src/expert-session.ts)
...
| `expert-refinement` | 未声明 | 无 | [`{ kind: "expert-refinement" }`](#persistence-type-sha256-d2cf3a97ba073c11bc235747fb4b29af2e7d6372e1903dcab25bfac70585671c) |
...
[`Message`](#persistence-type-sha256-589008a14b4a553da4e8193af798f158dad9b332678a75a04ec48b483d4a68da) 的数组。
...
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | 必需 | [`Message[]`](#persistence-type-sha256-fea15ba63bfa382cb74593bd570752ba87989f7fa837a22228af5aa8053c3095) |
...
[`UserMessage`](#persistence-type-sha256-21b191b46afad1f33242e386a860b368571f4890daaee84bc0fa40a77c6f3e61) 的数组。
...
| `expertId` | 必需 | `string` |
| `prompt` | 必需 | `string` |
| `source` | 必需 | [`ExpertPromptApplicationSource`](#persistence-type-sha256-baed6da2b88a4545200b1b145fba9a2869e2562cd641bd5c631c87db2eff7d70) |
| `version` | 必需 | `number` |
...
|---|---|---|
| `headerSeq` | 可选 | `number` |
| `message` | 必需 | [`DeveloperMessage`](#persistence-type-sha256-005bac9ddba7a376f052986f42dd2c78491368e26035cecb1f0747371c2f8af7) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `inserted` | 必需 | [`UserMessage[]`](#persistence-type-sha256-80e27128c41f6d841f476e55f9492f3cd77ace17927078d689674e93aa4e7e7d) |
| `outcome` | 可选 | `"canceled"` |
...
来源：[`packages/preset/agent-preset-registry/src/expert-session.ts:36`](../packages/preset/agent-preset-registry/src/expert-session.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `kind` | 必需 | `"expert-refinement"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-a86fb273b4591f1d8f0efb158d34f09466b3a22ae12487c1d35eb5680d50ead5) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-7608519a77d90954d5962bb7e2f6a671f0a961b9c2375bc349e69071a1183ad2) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ expertId, prompt, source, version }`](#persistence-type-sha256-bc1c28a3c3f0f501733f4d04f46ce60be528dcd2aa3f45a9f536e48985d67344) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"expert/prompt-applied"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-04231b6f57946aea548b28a225be1527ded2a580edc3fa6dae245ccd35670363) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`UserMessage`](#persistence-type-sha256-21b191b46afad1f33242e386a860b368571f4890daaee84bc0fa40a77c6f3e61) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
