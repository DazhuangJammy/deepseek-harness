...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  desktopPackager: 'desktop-packager.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ExpertRoster: 'expert roster is owned by packages/preset/agent-preset-registry/README.md',
  ExpertDocument: 'expert editor document is owned by packages/preset/agent-preset-registry/README.md',
  ExpertVersionComparison: 'expert version comparison is owned by packages/preset/agent-preset-registry/README.md',
  ExpertIcon: 'expert icon vocabulary is owned by packages/preset/agent-preset-registry/README.md',
  ExpertOptimizationOutcome: 'expert refinement settlement is owned by packages/preset/agent-preset-registry/README.md',
  ExpertOptimizationProposal: 'expert refinement candidate is owned by packages/preset/agent-preset-registry/README.md',
  ExpertOptimizationRun: 'expert refinement run identity is owned by packages/preset/agent-preset-registry/README.md',
  ExpertProposalId: 'expert proposal identity is owned by packages/preset/agent-preset-registry/README.md',
  ...
  DesktopPackagerStatus: 'packager build status is owned by packages/experimental/desktop-packager/README.md',
  DesktopPackagerStartResult: 'packager start outcome is owned by packages/experimental/desktop-packager/README.md',
  DesktopPackagerRevealResult: 'packager reveal outcome is owned by packages/experimental/desktop-packager/README.md',
  WebUpgradeRoute:
