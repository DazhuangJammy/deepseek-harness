...
| [desktop-packager.md](desktop-packager.md) | the opt-in Desktop packaging layer: one human-initiated unsigned build, its `ctx.desktopPackager` service, and the wire status it reports |
