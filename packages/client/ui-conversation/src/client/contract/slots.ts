...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Brand name shown as the blank-session headline. */
    'conversation.hero.brand.name': { kind: 'single'; scope: 'root'; owner: HeroBrandNameOwnerProps }
...
/** Empty owner share for the blank-session brand name. */
export interface HeroBrandNameOwnerProps {
  /** Marker field: the occupant owns its text. */
  children?: never
}
