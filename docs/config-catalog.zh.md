...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-experimental-desktop-packager -->
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-experimental-desktop-packager -->
...
| `@deepseek-ai/dsh-client-ui-learning` | — | [`packages/client/ui-learning/src/index.ts`](../packages/client/ui-learning/src/index.ts) |
